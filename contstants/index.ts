...
export const constants = {
  ...
  ABOUT: {
    ...
    SKILLS:
      'With 4 years of invaluable experience in the field, I have honed my skills in Vue.js, React.js, Next.js, TailwindCSS, and Typescript, allowing me to craft seamless andinteractive user experiences that engage and delight users. My passion for webdevelopment extends beyond the front-end, as I also have a solid understanding ofback-end frameworks such as Express.js and Nest.js, enabling me to create end-to-endsolutions that are both robust and user-friendly. I thrive on staying up-to-date withthe latest industry trends and technologies, and I am always eager to take on newchallenges and collaborate on exciting projects to push the boundaries of what’spossible in web development.',
    EXPERIENCE:
